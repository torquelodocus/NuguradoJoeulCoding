...
def from_projectile(x, y, color, width, height, facing):
    '''Creates a SpriteBox object at the given location with the given color, width, and height'''
    return SpriteBox(x, y, None, color, width, height, facing)
...
class SpriteBox(object):
    ...
    def __init__(self, x, y, image, color, w=None, h=None, facing=None):
